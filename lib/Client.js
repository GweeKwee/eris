    ...
    */
    async connect() {
        try {
            ...
            if(this.options.maxConcurrency === "auto") {
                if(data.session_start_limit && data.session_start_limit.max_concurrency) {
                    this.options.maxConcurrency = +data.session_start_limit.max_concurrency;
                } else {
                    throw new Error("Max concurrency missing!");
                }
            }
